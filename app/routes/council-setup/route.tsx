    ...
    <main className="2xl:container w-11/12 mx-auto">
      ...
      <div className="my-7 space-y-3">
        ...
        <p className="text-gray-400 text-sm max-w-md">
          Orchestrate your high-performance team of specialized AI agents.
          Adjust the hierarchy and define the cognitive parameters for maximum
          strategic output.
        </p>
      </div>
        ...
        <div className="lg:flex items-center justify-between gap-10">
          <div className="flex-1 space-y-3">
            <div className="flex items-center gap-2">
              ...
              <p className=" font-semibold text-white">Global Council Size</p>
            </div>
            <p className="text-[10px] text-gray-400">
              Define the total number of specialized agents in your assembly.
            </p>
          </div>
          {/* slider */}
