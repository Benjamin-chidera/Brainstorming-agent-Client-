  ...
  return (
    <main>
      <section className="mt-10">
        <div className="glass w-55 h-8.5 rounded-full flex items-center justify-center gap-2 mx-auto text-[#B6FF3B] font-semibold uppercase">
          <svg
            width="13"
            height="13"
            viewBox="0 0 13 13"
        ...
        <section className="2xl:container w-11/12 mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold max-w-xl lg:max-w-4xl mx-auto text-center mt-10 text-gray-200">
            Democratizing Strategy Through{" "}
            <span className="text-[#B6FF3B]">Collective Intelligence</span>
          </h1>

          <p className="text-xs md:text-sm text-[#8B949E] max-w-sm lg:max-w-xl mx-auto text-center mt-10">
