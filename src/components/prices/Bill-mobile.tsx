  ...
  const plans = [
    {
      ...
      features: ["2 AI agents", "10 sessions per month", "Community support"],
  ...
  return (
    <main className=" my-10">
              ...
              <TabsContent value={"monthly"} key={plan.id}>
                <Card className="p-3 glass w-[300px] h-[450px]">
                  ...
                  <CardContent>
                    ...
                    <Button className="w-full mt-4 bg-[#7F0DF2] text-white rounded-full">
                      {plan.cta}
                    </Button>
                    ...
                    <ul className="mt-7 space-y-2">
                      {plan.features.map((feature) => (
                        <li
                          key={feature}
                          className="text-muted-foreground text-[10px] text-start space-y-2 flex items-center gap-2 "
                        >
                          <CheckCircle size={12} color="#7F0DF2" />
                          {feature}
                        </li>
                      ))}
                    </ul>
            ...
            {plans.map((plan) => (
              <TabsContent value={"yearly"} key={plan.id}>
                <Card className="p-3 glass w-[300px] h-[450px]">
                  ...
                  <CardContent>
                    <h1 className="text-white text-3xl font-bold">
                      {Math.round(plan.price.yearly * 0.85)}
                      <span className="text-muted-foreground text-[10px]">
                        /monthly
                      </span>
                    </h1>
      ...
      <section className=" flex justify-center items-center mt-10 gap-5">
        <div>
          <Button
            className=" bg-[#7F0DF2] text-white w-30 py-2 font-bold"
            onClick={() => setSwitcher("free")}
          >
            Free
          </Button>
        </div>
