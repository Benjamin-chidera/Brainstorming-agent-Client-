          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className=" text-center">
              ...
              <section className=" mt-5 w-full sm:w-[398px] mx-auto space-y-4 sm:space-y-5 flex flex-col">
                ...
                <div>
                  <Button
                    className="w-full bg-[#B6FF3B] text-[#0D1117] hover:bg-[#B6FF3B]/90 hover:text-[#0D1117] cursor-pointer h-10 font-bold"
                    onClick={handleAuth}
                  >
              ...
              <p className="text-xs text-[#8B949E] mt-5">OR CONTINUE WITH</p>

              <section className="flex items-center gap-5 justify-around mt-5 w-full">
                {/* google */}
                <Button
                  className="glass w-[100px] md:w-[120px] lg:w-[150px] lg:h-[40px] rounded-full flex justify-center items-center gap-3 cursor-pointer  "
                ...
                >
                  ...
                  <p className="text-sm text-[#8B949E]">Google</p>
                </Button>
                {/* github   */}
              ...
              <div className="mt-5">
                <p className="text-xs text-[#8B949E]">
                  ...
                  <span
                    className="text-[#B6FF3B] cursor-pointer"
