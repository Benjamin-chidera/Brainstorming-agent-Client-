      ...
      <section className="lg:w-[896px] w-11/12  glass mx-auto rounded-3xl lg:mt-30 mt-15 flex justify-center flex-col items-center">
        ...
        <section className="grid grid-cols-2 gap-7 mt-10 p-5 lg:p-0">
          ...
          <div>
            ...
            <p className="text-xs text-[#8B949E] max-w-xs mt-2">
              Every strategic recommendation includes a 'Chain of Logic' trace,
              showing exactly which agents contributed and why.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-[#8B949E] max-w-xs mt-2">
              Your data never trains our global models. We utilize zero-
              knowledge architecture to ensure your strategy stays yours.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-[#8B949E] max-w-xs mt-2">
              A dedicated 'Adversarial Agent' is tasked with finding weaknesses
              and biases in every Council output.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-[#8B949E] max-w-xs mt-2">
              AI informs, humans decide. We design our interfaces to prioritize
              human agency in the final decision loop.
            </p>
          </div>
        </section>
      </section>
