  ...
  return (
    <main>
      <section className=" container mx-auto flex flex-col lg:flex-row items-center gap-10 lg:mt-32 mt-10 glass rounded-4xl justify-between">
        <div className="p-7">
          <h1 className="text-4xl font-bold max-w-2xl mx-auto lg:mt-10 mt-5 italic text-gray-200">
            "We didn't need a smarter model. We needed a better{" "}
            <span className="text-[#B6FF3B]">structure</span>."
          </h1>

          <div>
            <p className="text-sm text-[#8B949E] max-w-2xl mx-auto mt-5">
          ...
          <div>
            <p className="text-lg font-bold max-w-2xl mx-auto mt-3 text-gray-200">
              Benjamin Chidera
            </p>
            <p className="text-sm font-semibold text-[#B6FF3B] max-w-2xl mx-auto mt-3 ">
